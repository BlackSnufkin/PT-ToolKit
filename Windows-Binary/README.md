...
|**SharpWebServer**|Red Team oriented C# Simple HTTP & WebDAV Server with Net-NTLM hashes capture functionality|[mgeeky](https://github.com/mgeeky/SharpWebServer)
...
|**Dump**|Simple LSASS Dumper created using C++ as an alternative to using Mimikatz memory dumper|[Hifumi1337](https://github.com/Hifumi1337/lsass-dump)
